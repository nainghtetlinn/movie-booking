...
async function main() {
  ...
  const exampleMovies: Prisma.MovieCreateManyInput[] = [
    {
      ...
      duration_min: 152,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 30),
    ...
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 161,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 40),
      poster_url: 'https://picsum.photos/300/500',
      director: 'Chris Columbus',
      actors: 'Daniel Radcliffe, Emma Watson, Rupert Grint',
      genres: 'Magic',
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 142,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 50),
      poster_url: 'https://picsum.photos/300/500',
    ...
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 157,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 60),
      poster_url: 'https://picsum.photos/300/500',
    ...
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 138,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 70),
      poster_url: 'https://picsum.photos/300/500',
    ...
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 153,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 80),
      poster_url: 'https://picsum.photos/300/500',
      director: 'David Yates',
      actors: 'Daniel Radcliffe, Emma Watson, Rupert Grint',
      genres: 'Magic',
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 146,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 90),
      poster_url: 'https://picsum.photos/300/500',
      director: 'Chris Columbus',
      actors: 'Daniel Radcliffe, Emma Watson, Rupert Grint',
      genres: 'Magic',
    },
    {
      ...
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
      duration_min: 130,
      release_date: new Date(today.getTime() + 3600 * 1000 * 24 * 100),
      poster_url: 'https://picsum.photos/300/500',
      director: 'Chris Columbus',
      actors: 'Daniel Radcliffe, Emma Watson, Rupert Grint',
      genres: 'Magic',
  ...
  const exampleShows: Prisma.ShowCreateManyInput[] = []
  ...
  createdMovies.forEach(m => {
    exampleShows.push({
      ...
      start_time: new Date(
        new Date(m.release_date).getTime() + 3600 * 1000 * 10
      ),
      end_time: new Date(new Date(m.release_date).getTime() + 3600 * 1000 * 12),
    })
    exampleShows.push({
      movieId: m.id,
      date: new Date(m.release_date),
      start_time: new Date(
        new Date(m.release_date).getTime() + 3600 * 1000 * 13
      ),
      end_time: new Date(new Date(m.release_date).getTime() + 3600 * 1000 * 15),
    })
  })
  ...
  console.log(shows.count, 'Shows seeded successfully ...')
}
